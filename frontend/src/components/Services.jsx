        ...
        <div>
            <div className='relative mx-auto flex flex-col items-center lg:flex-row lg:gap-20 justify-center my-10'>
                ...
                <div className='w-[20rem] h-[20rem] xs:w-[25rem] xs:h-[25rem] sm:w-[30rem] sm:h-[28rem] overflow-hidden rounded-t-[15rem]'>
                    <img className='w-full h-full object-cover' src="https://images.unsplash.com/32/Mc8kW4x9Q3aRR3RkP5Im_IMG_4417.jpg?ixid=M3wxMjA3fDB8MXxzZWFyY2h8MTZ8fGJhY2tncm91bmQlMjBpbWFnZXxlbnwwfHx8fDE3MDU0NzA4MTZ8MA&ixlib=rb-4.0.3" alt="" />
                </div>
                                ...
                                <AccordionItem className='bg-white border-[0.8px] border-solid border-[rgba(128, 128, 128, 0.143)] rounded-[8px] overflow-hidden mb-[20px]' key={i} uuid={i}>
                                    <AccordionItemHeading>
                                        <AccordionItemButton className='flex justify-between cursor-pointer bg-white p-[1rem] w-full'>
                                            <div className="flex items-center text-blue-600 justify-center p-[10px] bg-blue-100 rounded-[5px]">{item.icon}</div>
